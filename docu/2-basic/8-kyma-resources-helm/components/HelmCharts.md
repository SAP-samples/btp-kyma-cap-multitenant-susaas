...
In your *my-config-map.yaml* file, you can now reuse this *named template*. Open your [my-config-map.yaml](../../../../code/charts/sustainable-saas/templates/my-config-map.yaml) file and edit it as shown below.
